...
class TestCalcRating:
    ...
    def input_data(self) -> tuple[DataType, RatingsType]:
        ...
        rating_scores: RatingsType = {
            "Иванов Иван Иванович": 86.00,
            "Петров Петр Петрович": 75.33,
            "Иванов Петр Дмитриевич": 64.33,
            "Антонов Антон Денисович": 68.33,
            "Пупкин Демид Романович": 92.66,
            "Добров Иван Александрович": 75.33,
        }
